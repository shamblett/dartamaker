...
void main() {
  group('Plugins', () {
    test('Airports', () {
      final DartamakerPluginAirport airport =
          Dartamaker().plugin(DartamakerTagNames.airport, null) as DartamakerPluginAirport;
    ...
    test('Auto Increment', () {
      final DartamakerPluginAutoinc autoinc =
          Dartamaker().plugin(DartamakerTagNames.autoinc, null) as DartamakerPluginAutoinc;
    ...
    test('Boolean', () {
      final DartamakerPluginBoolean b1 = Dartamaker().plugin(
          DartamakerTagNames.boolean, DartamakerConstants.pluginNullParam) as DartamakerPluginBoolean;
      ...
      final DartamakerPluginBoolean b2 =
          Dartamaker().plugin(DartamakerTagNames.boolean, p1) as DartamakerPluginBoolean;
      expect(b2.apply(), 'true');
      final p2 = <String, String>{DartamakerConstants.probability: '0.0'};
      final DartamakerPluginBoolean b3 =
          Dartamaker().plugin(DartamakerTagNames.boolean, p2) as DartamakerPluginBoolean;
      ...
      final DartamakerPluginBoolean b4 =
          Dartamaker().plugin(DartamakerTagNames.boolean, p3) as DartamakerPluginBoolean;
      expect(b4.apply(), anyOf('true', 'false'));
    });
    test('Cats', () {
      final DartamakerPluginCat cat =
          Dartamaker().plugin(DartamakerTagNames.cat, null) as DartamakerPluginCat;
      final cats = cat.cats;
      final a1 = cat.apply();
    ...
    test('Cities', () {
      final DartamakerPluginCity city =
          Dartamaker().plugin(DartamakerTagNames.city, null) as DartamakerPluginCity;
    ...
    test('Words', () {
      final DartamakerPluginWord word =
          Dartamaker().plugin(DartamakerTagNames.word, null) as DartamakerPluginWord;
    ...
    test('Company', () {
      final DartamakerPluginCompany? company =
          Dartamaker().plugin(DartamakerTagNames.company, null) as DartamakerPluginCompany?;
      for (var i = 0; i <= 9; i++) {
    ...
    test('Countries', () {
      final DartamakerPluginCountry country =
          Dartamaker().plugin(DartamakerTagNames.country, null) as DartamakerPluginCountry;
    ...
    test('Counties', () {
      final DartamakerPluginCounty county =
          Dartamaker().plugin(DartamakerTagNames.county, null) as DartamakerPluginCounty;
    ...
    test('Digits', () {
      final DartamakerPluginDigits b1 = Dartamaker().plugin(
          DartamakerTagNames.digits, DartamakerConstants.pluginNullParam) as DartamakerPluginDigits;
      expect(b1.apply().length, 5);
      final p1 = <String, String>{DartamakerConstants.numdigits: '20'};
      final DartamakerPluginDigits b2 =
          Dartamaker().plugin(DartamakerTagNames.digits, p1) as DartamakerPluginDigits;
      expect(b2.apply().length, 20);
    });
    test('Credit card', () {
      final DartamakerPluginCreditcard? card =
          Dartamaker().plugin(DartamakerTagNames.creditcard, null) as DartamakerPluginCreditcard?;
      for (var i = 0; i <= 9; i++) {
    ...
    test('Dogs', () {
      final DartamakerPluginDog dog =
          Dartamaker().plugin(DartamakerTagNames.dog, null) as DartamakerPluginDog;
      final dogs = dog.dogs;
      final a1 = dog.apply();
    ...
    test('TLDs', () {
      final DartamakerPluginTLD tld =
          Dartamaker().plugin(DartamakerTagNames.tld, null) as DartamakerPluginTLD;
      final tlds = tld.tlds;
      final a1 = tld.apply();
    ...
    test('Domain Name', () {
      final DartamakerPluginDomainname? dn =
          Dartamaker().plugin(DartamakerTagNames.domainname, null) as DartamakerPluginDomainname?;
      for (var i = 0; i <= 9; i++) {
        final name = dn!.apply();
        expect(name.isNotEmpty, isTrue);
      }
    ...
    test('First Names', () {
      final DartamakerPluginFirstname name =
          Dartamaker().plugin(DartamakerTagNames.firstname, null) as DartamakerPluginFirstname;
    ...
    test('Surnames', () {
      final DartamakerPluginSurname name =
          Dartamaker().plugin(DartamakerTagNames.surname, null) as DartamakerPluginSurname;
      final names = name.names;
      final a1 = name.apply();
      expect(a1, anyOf(names));
    });
    test('Email', () {
      final DartamakerPluginEmail? email =
          Dartamaker().plugin(DartamakerTagNames.email, null) as DartamakerPluginEmail?;
      for (var i = 0; i <= 9; i++) {
    ...
    test('Emojii', () {
      final DartamakerPluginEmojii b1 = Dartamaker().plugin(
          DartamakerTagNames.emojii, DartamakerConstants.pluginNullParam) as DartamakerPluginEmojii;
      expect(b1.apply().isNotEmpty, isTrue);
      final p1 = <String, String>{DartamakerConstants.numchars: '20'};
      final DartamakerPluginEmojii b2 =
          Dartamaker().plugin(DartamakerTagNames.emojii, p1) as DartamakerPluginEmojii;
      expect(b2.apply().isNotEmpty, isTrue);
    });
    test('Float', () {
      final DartamakerPluginFloat b1 = Dartamaker().plugin(
          DartamakerTagNames.float, DartamakerConstants.pluginNullParam) as DartamakerPluginFloat;
      var res = b1.apply();
    ...
    test('Integer', () {
      final DartamakerPluginInteger b1 = Dartamaker().plugin(
          DartamakerTagNames.integer, DartamakerConstants.pluginNullParam) as DartamakerPluginInteger;
      var res = b1.apply();
    ...
    test('Currency', () {
      final DartamakerPluginCurrency currency =
          Dartamaker().plugin(DartamakerTagNames.currency, null) as DartamakerPluginCurrency;
    ...
    test('Date ISO', () async {
      ...
      final DartamakerPluginDateiso b1 = Dartamaker().plugin(
          DartamakerTagNames.dateiso, DartamakerConstants.pluginNullParam) as DartamakerPluginDateiso;
      var res = b1.apply();
    ...
    test('Date', () {
      final DartamakerPluginDate b1 = Dartamaker()
          .plugin(DartamakerTagNames.date, DartamakerConstants.pluginNullParam) as DartamakerPluginDate;
      final res = b1.apply();
    ...
    test('Latitude', () {
      final DartamakerPluginLatitude b1 = Dartamaker().plugin(
          DartamakerTagNames.latitude, DartamakerConstants.pluginNullParam) as DartamakerPluginLatitude;
      final res = b1.apply();
    ...
    test('Longitude', () {
      final DartamakerPluginLongitude b1 = Dartamaker().plugin(
          DartamakerTagNames.longitude, DartamakerConstants.pluginNullParam) as DartamakerPluginLongitude;
      final res = b1.apply();
      final val = double.tryParse(res)!;
    ...
    test('Letters', () {
      final DartamakerPluginLetters b1 = Dartamaker().plugin(
          DartamakerTagNames.letters, DartamakerConstants.pluginNullParam) as DartamakerPluginLetters;
      expect(b1.apply().length, 5);
      final p1 = <String, String>{DartamakerConstants.numletters: '20'};
      final DartamakerPluginLetters b2 =
          Dartamaker().plugin(DartamakerTagNames.letters, p1) as DartamakerPluginLetters;
      final res = b2.apply();
      expect(res.length, 20);
    });
    test('Names', () {
      final DartamakerPluginName name =
          Dartamaker().plugin(DartamakerTagNames.name, null) as DartamakerPluginName;
    ...
    test('Normal', () {
      final DartamakerPluginNormal b1 = Dartamaker().plugin(
          DartamakerTagNames.normal, DartamakerConstants.pluginNullParam) as DartamakerPluginNormal;
      var res = b1.apply();
    ...
    test('One of', () {
      final DartamakerPluginOneof name = Dartamaker().plugin(
          DartamakerTagNames.oneof, DartamakerConstants.pluginNullParam) as DartamakerPluginOneof;
      final a1 = name.apply();
      expect(a1, 'NoneSet');
      ...
      final DartamakerPluginOneof b2 = Dartamaker().plugin(
          ...
          <String, String>{DartamakerConstants.args: names}) as DartamakerPluginOneof;
      final a2 = b2.apply();
      expect(names.contains(a2), isTrue);
    });
    test('Postcode', () {
      final DartamakerPluginPostcode code =
          Dartamaker().plugin(DartamakerTagNames.postcode, null) as DartamakerPluginPostcode;
      final a1 = code.apply();
    ...
    test('Price', () {
      final DartamakerPluginPrice b1 = Dartamaker().plugin(
          DartamakerTagNames.price, DartamakerConstants.pluginNullParam) as DartamakerPluginPrice;
      var res = b1.apply();
    ...
    test('States', () {
      final DartamakerPluginState state =
          Dartamaker().plugin(DartamakerTagNames.state, null) as DartamakerPluginState;
    ...
    test('State Codes', () {
      final DartamakerPluginStatecode statecode =
          Dartamaker().plugin(DartamakerTagNames.statecode, null) as DartamakerPluginStatecode;
    ...
    test('Streets', () {
      final DartamakerPluginStreet street =
          Dartamaker().plugin(DartamakerTagNames.street, null) as DartamakerPluginStreet;
    ...
    test('Telephone numbers', () {
      final DartamakerPluginTel tel =
          Dartamaker().plugin(DartamakerTagNames.tel, null) as DartamakerPluginTel;
    ...
    test('Time', () {
      final DartamakerPluginTime t =
          Dartamaker().plugin(DartamakerTagNames.time, null) as DartamakerPluginTime;
      final a1 = t.apply();
      final parts = a1.split(':');
    ...
    test('Timestamp', () {
      final DartamakerPluginTimestamp t =
          Dartamaker().plugin(DartamakerTagNames.timestamp, null) as DartamakerPluginTimestamp;
      final a1 = t.apply();
      expect(a1.length, anyOf(13, 14, 15));
    });
    test('Titles', () {
      final DartamakerPluginTitle title =
          Dartamaker().plugin(DartamakerTagNames.title, null) as DartamakerPluginTitle;
    ...
    test('Towns', () {
      final DartamakerPluginTown town =
          Dartamaker().plugin(DartamakerTagNames.town, null) as DartamakerPluginTown;
    ...
    test('Uuids', () {
      final DartamakerPluginUuid b1 = Dartamaker()
          .plugin(DartamakerTagNames.uuid, DartamakerConstants.pluginNullParam) as DartamakerPluginUuid;
      expect(b1.apply().length, 16);
      final p1 = <String, String>{DartamakerConstants.length: '30'};
      final DartamakerPluginUuid b2 =
          Dartamaker().plugin(DartamakerTagNames.uuid, p1) as DartamakerPluginUuid;
      final res = b2.apply();
      expect(res.length, 30);
    });
    test('Websites', () {
      final DartamakerPluginWebsite ws =
          Dartamaker().plugin(DartamakerTagNames.website, null) as DartamakerPluginWebsite;
      final a1 = ws.apply();
      expect(a1.startsWith('http'), isTrue);
    });
    test('Urls', () {
      final DartamakerPluginUrl url =
          Dartamaker().plugin(DartamakerTagNames.url, null) as DartamakerPluginUrl;
      final a1 = url.apply();
      expect(a1.startsWith('http'), isTrue);
    });
    test('Words', () {
      final DartamakerPluginWords words = Dartamaker().plugin(
          DartamakerTagNames.words, DartamakerConstants.pluginNullParam) as DartamakerPluginWords;
      var a1 = words.apply();
      expect(a1.split(' ').length, 5);
      final DartamakerPluginWords words1 = Dartamaker().plugin(
          DartamakerTagNames.words,
          <String, String>{DartamakerConstants.count: '20'}) as DartamakerPluginWords;
      a1 = words1.apply();
      expect(a1.split(' ').length, 20);
    });
    test('Zip codes', () {
      final DartamakerPluginZip zip =
          Dartamaker().plugin(DartamakerTagNames.zip, null) as DartamakerPluginZip;
      final a1 = zip.apply();
      expect(a1.length, 5);
    });
  });
  ...
  group('By Tag Name', () {
    ...
    test('Integer - 2 param', () {
      final DartamakerPluginInteger integer =
          Dartamaker().byTagName('integer', '1000 2000') as DartamakerPluginInteger;
      expect(integer, isA<DartamakerPluginInteger>());
    ...
    test('Float - default', () {
      final DartamakerPluginFloat float = Dartamaker().byTagName('float', '') as DartamakerPluginFloat;
    ...
    test('Float - 3 param', () {
      final DartamakerPluginFloat float =
          Dartamaker().byTagName('float', '1000.0 2000.0 6') as DartamakerPluginFloat;
      expect(float, isA<DartamakerPluginFloat>());
      final a1 = float.apply();
    ...
    test('Float - 2 param', () {
      final DartamakerPluginFloat float =
          Dartamaker().byTagName('float', '1000.0 2000.0') as DartamakerPluginFloat;
      expect(float, isA<DartamakerPluginFloat>());
      final a1 = float.apply();
      expect(double.tryParse(a1)! >= 1000.0, isTrue);
      expect(double.tryParse(a1)! <= 2000.0, isTrue);
